...
userRouter.post('/logout', updateAccessToken, isAuthenticated, logoutUser);
...
userRouter.put('/update-user', updateAccessToken, isAuthenticated, authorizeRoles('admin'), updateUsersRole);
