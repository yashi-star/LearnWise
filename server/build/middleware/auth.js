...
exports.isAuthenticated = (0, catchAsyncErrors_1.CatchAsyncError)(async (req, res, next) => {
    ...
    if (!access_token) {
        return next(new ErrorHandler_1.default('Please login to access this router', 400));
    }
    ...
    if (!user) {
        return next(new ErrorHandler_1.default("Plase login to access this course", 400));
    }
