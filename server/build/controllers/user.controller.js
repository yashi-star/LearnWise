...
exports.registrationUser = (0, catchAsyncErrors_1.CatchAsyncError)(async (req, res, next) => {
    try {
        ...
        if (isEmailExist) {
            return next(new ErrorHandler_1.default("Email already exsist", 400));
        }
        ;
        const user = {
            name,
...
exports.loginUser = (0, catchAsyncErrors_1.CatchAsyncError)(async (req, res, next) => {
    try {
        ...
        if (!email || !password) {
            return next(new ErrorHandler_1.default("Pleaseenter email and password", 400));
        }
...
exports.updatePassword = (0, catchAsyncErrors_1.CatchAsyncError)(async (req, res, next) => {
    try {
        ...
        if (!oldPassword || !newPassword) {
            return next(new ErrorHandler_1.default("please enter old andnew password", 400));
        }
...
exports.updateUsersRole = (0, catchAsyncErrors_1.CatchAsyncError)(async (req, res, next) => {
    try {
