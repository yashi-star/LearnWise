                ...
                <div className='space-y-3'>
                    ...
                    <div className='space-y-3'>
                        ...
                        <ul className='space-y-4'>
                            <li>
                                <Link
                                href="https://www.youtube.com/@yashipant5305"
                                className='text-base text-black dark:text-gray-300 dark:hover:text-white'>
                                    You Tube
                                </Link>
                            </li>
                            <li>
                                <Link
                                href="https://github.com/yashi-star"
                                className='text-base text-black dark:text-gray-300 dark:hover:text-white'>
                                    GitHub
                                </Link>
                            </li>
                    ...
                    <p className='text-base text-black dark:text-gray-300 dark:hover:text-white pb-2'>
                        Call Us: 6446-4565-654
                    </p>
                    <p className='text-base text-black dark:text-gray-300 dark:hover:text-white pb-2'>
                        Address: Graphic Era Hill University, Dehradun
                    </p>
                    <p className='text-base text-black dark:text-gray-300 dark:hover:text-white pb-2'>
                        Mail Us: yashipant03@gmail.com
                    </p>
                    </div>
        </div>
        <br/>
        <p className='text-center text-black dark:text-white'>
                        CopyRight @ 2025 LearnWise | All Rights Reserved
                    </p>
                    </div>
                    <br/>
    </footer>
