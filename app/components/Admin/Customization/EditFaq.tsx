...
const EditFaq = () => {
    ...
    const areQuestionsUnchanged=(
        orignalQuestions:any[],
        newQuestions:any[],
    )=>{
        return JSON.stringify(orignalQuestions)===JSON.stringify(newQuestions);
    };
  ...
  return (
    <>
    {
        ...
        <div
        className={`${
            styles.button} !w-[100px] !min-h-[40px] !h-[40px] dark:text-white text-black bg-[#cccccc34] *:${
            areQuestionsUnchanged(data.layout.faq, questions)|| 
            isAnyQuestionEmpty(questions)?
        "!cursor-not-allowed" : "!cursor-pointer !bg-[#42b8d3]"}
